...
import com.example.cvbuilderapp.constants.Constant.SHARED_PREF_NAME
...
class LoginActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun initSharedPreference() {
        ...
        editor.putString(USER_EMAIL, "khkc@miu.edu")
        editor.putString(USER_PASSWORD, "khkc")
        editor.putString(USER_NAME, "Ananda KC")
